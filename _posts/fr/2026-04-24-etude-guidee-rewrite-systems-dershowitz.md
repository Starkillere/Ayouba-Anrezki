...
- **Théorème 8** : un système terminant est confluent si et seulement si il est *localement* confluent (confluence à une seule étape de divergence), ce qui ramène un problème global à une propriété locale.
